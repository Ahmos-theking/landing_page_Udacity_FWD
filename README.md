...
1- HTML file (LandingPage.HTML) which contains the basic skeleton of the project.
2- CSS file (styles.CSS) which contains all the styles of the project.
3- JavaScript file (app.JS) which contains all the dynamic codes for the dynamic navbar. 
